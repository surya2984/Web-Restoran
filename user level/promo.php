        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <div class="col-md-3 d-flex">
                    <div class="card">
                        <img src="../admin level/Aset/' . $row['image'] . '" class="card-img-top" alt="' . htmlspecialchars($row['deskripsi']) . '">
                        <div class="card-body">
                            <h6 class="card-title text-center bg-primary text-white">#' . htmlspecialchars($row['kategori']) . '</h6>
                            <h6 class="card-title">Kode Promo: ' . htmlspecialchars($row['kode_promo']) . '</h6>
                            <p class="card-text">' . htmlspecialchars($row['deskripsi']) . '</p>
                            <span class="price position-absolute bottom-0 start-"50">Diskon Sebesar: ' .  htmlspecialchars($row['diskon']) . ' %</span>
